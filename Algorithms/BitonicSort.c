...
/*Sorts a bitonic sequence in ascending order if dir=1 otherwise in descending order*/
...
/*Generates bitonic sequence by sorting recursively two halves of the array in oppsite sorting orders bitonicmerge will merge the resultant data*/
